...
export default function SystemHealth() {
  const { data: health, isLoading } = useQuery({
    ...
    queryFn: () => api.get<SystemHealthData>('/stats/health').then(r => r.data),
      ...
      <div className="bg-white rounded-lg shadow p-4 border-l-4 border-blue-500">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-gray-900 mt-1">{health.active_jobs}</p>
          </div>
      ...
      <div className="bg-white rounded-lg shadow p-4 border-l-4 border-purple-500">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-gray-900 mt-1">{health.storage_health}</p>
          </div>
