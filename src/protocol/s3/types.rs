...
impl S3StorageClass {
    ...
    pub fn to_aws(&self) -> aws_sdk_s3::types::StorageClass {
        match self {
            ...
            S3StorageClass::IntelligentTiering => aws_sdk_s3::types::StorageClass::IntelligentTiering,
    ...
    pub fn from_aws(sc: &aws_sdk_s3::types::StorageClass) -> Self {
        match sc {
            ...
            aws_sdk_s3::types::StorageClass::IntelligentTiering => S3StorageClass::IntelligentTiering,
...
mod tests {
    ...
    fn test_storage_class_display() {
        ...
        assert_eq!(S3StorageClass::GlacierInstantRetrieval.to_string(), "GLACIER_IR");
    }
    ...
    fn test_resume_state_progress() {
        ...
        state.completed_parts.push(UploadPartInfo::new(1, "etag1".to_string(), 5242880));
        assert!(state.has_progress());
