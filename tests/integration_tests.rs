...
fn test_zero_copy_capabilities_detection() {
    ...
    #[cfg(any(target_os = "linux", target_os = "macos", target_os = "windows"))]
    {
        assert!(
            caps.available,
            "Zero-copy should be available on this platform"
        );
        assert!(
            !caps.method.is_empty(),
            "Zero-copy method should be specified"
        );
    }
    ...
    #[cfg(not(any(target_os = "linux", target_os = "macos", target_os = "windows")))]
    {
        assert!(
            !caps.available,
            "Zero-copy should not be available on this platform"
        );
    }
}
