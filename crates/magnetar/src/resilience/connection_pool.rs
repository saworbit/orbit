...
impl PoolConfig {
    /// Configuration optimized for "Gigantor" (Large File) workloads.
    ///
    ...
    ///
    /// ```
    /// use magnetar::resilience::connection_pool::PoolConfig;
    ///
...
///
/// #[async_trait::async_trait]
/// impl ConnectionFactory<hyper::Client<hyper::client::HttpConnector>> for HttpClientFactory {
///     async fn create(&self) -> Result<hyper::Client<hyper::client::HttpConnector>, ResilienceError> {
///         Ok(hyper::Client::new())
///     }
///
///     async fn is_healthy(&self, _conn: &hyper::Client<hyper::client::HttpConnector>) -> bool {
///         true
///     }
/// }
///
